...
<body>
                    ...
                    <div class="owl-carousel owl-theme">
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-01.jpg')}}" alt="Item 1">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-02.jpg')}}" alt="Item 2">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-03.jpg')}}" alt="Item 3">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-04.jpg')}}" alt="Item 4">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-05.jpg')}}" alt="Item 5">
                                <h4>Morbi aliquet</h4>
                                <h6>$55.00</h6>
                            </div>
                        </a>
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-06.jpg')}}" alt="Item 6">
                                <h4>Urna ac diam</h4>
                                <h6>$65.00</h6>
                            </div>
                        </a>
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-04.jpg')}}" alt="Item 7">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-05.jpg')}}" alt="Item 8">
                        ...
                        <a href="single-product.html">
                            <div class="featured-item">
                                <img src="{{asset('asset/images/item-06.jpg')}}" alt="Item 9">
                                <h4>Cras tempus</h4>
                                <h6>$95.00</h6>
                            </div>
                        </a>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <img src="{{asset('asset/images/header-logo.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-12">
    ...
    <script src="{{asset('aseet/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
